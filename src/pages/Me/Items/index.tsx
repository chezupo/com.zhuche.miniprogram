...
const WechatNote = (props: NotePropstype): React.ReactElement => {
  return (
    <View className={style.wechatNoteWrapper}>
      ...
      <View className={style.wechatNote}>{props.title}</View>
    </View>
  );
};
...
const Items = (): React.ReactElement => {
  ...
  const items: ItemContainerType[] = [
    {
      title: "我的账单",
      icon: <Icon value="transaction" style={iconStyle} />,
      eventType: ItemContainerEventType.TRANSACTION
    },
      ...
      ? [
          {
            title: "绑定公众号",
            icon: (
              <Icon value="wechat" style={{ ...iconStyle, fontSize: "6vw" }} />
            ),
            eventType: ItemContainerEventType.WECHAT_OFFICE,
            note: <WechatNote title="待绑定" />
          }
        ]
      : []),
    {
      title: "违章查询",
      icon: <Icon value="weizhangshigujilu" style={iconStyle} />,
      eventType: ItemContainerEventType.VIOLATION
    },
    {
      title: "紧急联系人",
      icon: <Icon value="lianxiren" style={iconStyle} />,
      eventType: ItemContainerEventType.CONTACT
    },
    {
      title: "身份认证",
      icon: <Icon value="shenfenzheng" style={iconStyle} />,
      eventType: ItemContainerEventType.ID_CAR
    },
    {
      title: "驾照认证",
      icon: <Icon value="kaojiazhao" style={iconStyle} />,
      eventType: ItemContainerEventType.DRIVER_S_LICENSE
    },
    {
      title: "我的推广",
      icon: <Icon value="promotion" style={iconStyle} />,
      eventType: ItemContainerEventType.PROMOTION
    }
  ];
