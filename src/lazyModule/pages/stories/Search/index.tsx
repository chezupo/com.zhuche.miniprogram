...
const SearchInputRender: React.FC<SearchInputRenderPropsType> = ({
  onCancel,
  onChange,
  value
}) => {
...
} & SearchSpinnerRenderPropsType &
  SearchInputRenderPropsType;
      ...
      <View className={style.container}>
        {props.isSearchMode ? (
          ...
          <SearchSpinnerRender
            ...
            onClickMapButton={props.onClickMapButton}
          />
        )}
      </View>
    </View>
