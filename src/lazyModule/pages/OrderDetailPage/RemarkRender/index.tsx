      ...
      <View className={style.container} >
        <View className={style.itemWrapper}>
          <View className={style.statusWrapper}>
            <View className={style.status}>{getStatusMapInfo(props.order).title}</View>
            <View className={style.remark}>已为您预留车辆，用车请随身携带必备的证件</View>
          </View>
            ...
            <View className={style.carItemWrapper}>
              <View className={style.leftWrapper}>
                <View className={style.item}>
                  <Point className={style.point}  /><View>取车必备驾驶员本人身份证+中国大陆驾照</View>
                </View>
                <View className={style.item}>
                  <Point className={style.point}  /><View>了解取还车流程</View>
                </View>
                <View className={style.item}>
                  <Point className={style.point}  /> <View>关于疫情常态化下出行重要信息提醒</View>
                </View>
              </View>
