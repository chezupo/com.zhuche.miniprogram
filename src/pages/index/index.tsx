  ...
  return (
    <Layout
      tabs={[
        {
          name: "首页",
          icon: <Icon value="car-o" style={{ fontSize: "7vw" }} />,
          type: TabBarType.HOME,
          element: <IndexRender />,
          navTitle: configuration.config.appName
        },
        {
          name: "订单",
          icon: <Icon value="order" style={{ fontSize: "7vw" }} />,
          type: TabBarType.ORDER,
          element: <Order />,
          navTitle: "全部订单",
          isPermission: true
        },
        {
          name: "我的",
          icon: <Icon value="user" style={{ fontSize: "7vw" }} />,
          type: TabBarType.ME,
          element: <Me />,
          navTitle: "我的"
        }
