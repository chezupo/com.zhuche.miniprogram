...
const SelectCityOrAttraction = (
  props: SelectCityOrAttractionPropsType
): React.ReactElement => {
    ...
    <>
      ...
      <View className={style.storeWrapper}>
        ...
        <View className={style.cityAndStore}>
          {props.cityName ? (
            <View className={style.city} onClick={() => props.onClickCity()}>
              {props.cityName}
            </View>
          ) : (
            <View
              className={[style.city, style.noticeColor].join(" ")}
          ...
          {props.storeName ? (
            ...
            <View
              className={[
                style.store,
                !props.storeName ? style.noticeColor : ""
              ].join(" ")}
