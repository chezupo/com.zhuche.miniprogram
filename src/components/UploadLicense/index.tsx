...
const UploadLicense: React.FC<UploadLicensePropsType> = ({
  url,
  onChange,
  ...props
}) => {
  ...
  return (
    <View className={style.main} onClick={handleChooseImage}>
      <View className={style.container}>
        ...
        {!!url && (
          <Image src={url} mode="scaleToFill" className={style.image} />
        )}
      </View>
