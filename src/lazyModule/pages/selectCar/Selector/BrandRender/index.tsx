...
const BrandRender = (): React.ReactElement => {
  const [brands, setBrands] = useState<BrandType[]>([
    ...
    },
    {
      ...
      name: "奔驰",
      isCheckAll: false,
      series: [{ id: 2, name: "A200", isCheck: false }],
      url: "https://zhuche-a1001.qiniu.wuchuheng.com/beici.png"
    },
    {
      id: 3,
      name: "别克",
    ...
    },
    {
      ...
      name: "荣威",
      isCheckAll: false,
      series: [{ id: 20, name: "ERX5", isCheck: false }],
    ...
    },
    {
      ...
      name: "现代",
      isCheckAll: false,
      series: [{ id: 21, name: "IX35", isCheck: false }],
  ...
  const handleActiveSeries = (activeSeries: SeriesType): void => {
    ...
    tmpActiveBrand.series = [
      ...tmpActiveBrand.series.map(i =>
        i.id === activeSeries.id
          ? { ...activeSeries, isCheck: !activeSeries.isCheck }
          : i
      )
    ];
    ...
    const newBrands = tmpBrands.map(i =>
      i.id === tmpActiveBrand.id ? tmpActiveBrand : i
    );
    setBrands(newBrands);
  };
  const handleClean = (): void => {
    ...
    setActiveBrand(() => ({
      ...activeBrand,
      isCheckAll: false,
      series: activeBrand.series.map(series => ({ ...series, isCheck: false }))
    }));
  };
