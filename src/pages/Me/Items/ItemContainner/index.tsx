...
const ItemContainer = (props: ItemContainerPropsType): React.ReactElement => {
  return (
    ...
    >
      <View className={[style.icon].join(" ")}>{props.data.icon}</View>
        ...
        <View className={style.noteWrapper}>
          {props.data.note && (
            <View
              className={[
                style.subtitle,
                props.data.noteClassName ? props.data.noteClassName : ""
              ].join(" ")}
            >
              {props.data.note}
            </View>
          ...
          <View
            className={["at-icon at-icon-chevron-right", style.rightIcon].join(
              " "
            )}
          />
        </View>
