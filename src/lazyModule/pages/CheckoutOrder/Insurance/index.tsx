...
const Insurance: React.FC<InsurancePropsType> = props => {
  ...
  let insuranceAgreement = useAppSelector(
    state => state.configuration.config.insuranceAgreement
  );
            ...
            <View>
              <View className={style.itemTitle}>
                ...
                <Icon
                  ...
                  onClick={() => setVisitableDetail(!visitableDetail)}
                />
              </View>
      ...
      {visitableDetail && (
        <SpinContainer className={style.spinContainer}>
          <View className={style.contentContainer}>
            <ScrollView className={style.content} scrollY>
